            ...
            <form onsubmit="shopLib.registerNewUser(event)" method="POST" class="register-form">
                ...
                <div class="checkout-form__container">
                    <section class="checkout-form__delivery-section">
                        ...
                        <input class="checkout-form__delivery-section__input" required id="tel" type="text" name="phone" placeholder="073-111 22 33" pattern="0[0-9]{1,3}-?[0-9 ]{6,9}" minlength=10 maxlength=13>
