...
<body class="single-product-page__body">
                ...
                <section class="user-details white-panel">
                    ...
                    <div id="user-details-div" class="">
                        ...
                        <div class="change-btn-container">
                            <button type="button" id="editUserDetailsButton" class="changeInput">Ändra uppgifter</button>
                        </div>

                    </div>


                    <div id="edit-user-div" class="panel-content hidden">
                        <form onsubmit="shopLib.updateUserData(event)" method="POST" class="edit-user-form">
    ...
    <?php require_once __DIR__ . '/php/view/jscore.php';?>
        <script type="text/javascript" src="./js/user/userDetailsManager.js"></script>
